...
%store and save data%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
subject_data_90 = struct('SubjectNumber', sub_num, 'ControlVoltageOutput', voltages_tested, 'ApproximateI', intensities_tested, 'ResponseMatrix', responses, 'YesResponseTime', res_time_yes, 'NoResponseTime', res_time_no);

filename = sprintf('%s %d %s', 'Subject', sub_num, 'P90.mat');
save(filename, 'subject_data_90')
